...
public class SsOOrganizzazione implements Serializable {
	...
	private boolean flag_ricevi_schede_accoglienza; 
	...
	public boolean isFlag_ricevi_schede_accoglienza() {
		return flag_ricevi_schede_accoglienza;
	}

	public void setFlag_ricevi_schede_accoglienza(
			boolean flag_ricevi_schede_accoglienza) {
		this.flag_ricevi_schede_accoglienza = flag_ricevi_schede_accoglienza;
	}
