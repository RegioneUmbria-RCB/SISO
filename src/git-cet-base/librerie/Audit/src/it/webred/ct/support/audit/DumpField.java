		...
		try {
			...
			if (oClass.isPrimitive() || oClass == java.lang.Long.class
				...
				while (iterator.hasNext()) {
					...
					if(type!=null && type.getClass().getAnnotation( AuditInherit.class ) != null){
						inheritedAudit = true;
					}
					if(type!=null && type.getClass().getAnnotation( AuditAnnotedFields.class ) != null){
						dumpAllFields = false;
					}
			...
			logger.error("Impossibile fare il dump dei fields [errore non bloccante] ",e);
