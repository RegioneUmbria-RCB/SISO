package it.webred.ct.proc.ario.fonti.oggetto.curit;
...
public class OggettoCurit extends DatoDwh implements Oggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(OggettoCurit.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlOggettoCatasto1 = this.getProperty("SQL_OGG_CURIT");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Oggetto Curit: "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Oggetto Curit: "+e.getMessage());
			throw ea;
		}					
