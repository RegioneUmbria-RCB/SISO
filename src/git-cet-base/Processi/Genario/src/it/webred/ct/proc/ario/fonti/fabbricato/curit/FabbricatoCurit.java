package it.webred.ct.proc.ario.fonti.fabbricato.curit;
...
public class FabbricatoCurit  extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoCurit.class.getName());
	
	public FabbricatoCurit(){
	...
	public String getSql(String processID) {
		String sqlFabbricato = this.getProperty("SQL_FABB_CURIT");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs,String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{
			...
			log.warn("Errore:Save Fabbricato Curit: "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Fabbricato Curit: "+e.getMessage());
			throw ea;
		}
