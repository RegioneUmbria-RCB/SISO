...
public class ImportDemogAnagrafeMilano <T extends  Env<?>> extends ConcreteImport<T>  {
	...
	@Override
	public it.webred.rulengine.brick.loadDwh.load.demografia.milanoCoordCat.v1.Env<DemogAnagrafeMilanoEnv> getEnvSpec(EnvImport ei) {
		return new it.webred.rulengine.brick.loadDwh.load.demografia.milanoCoordCat.v1.Env<DemogAnagrafeMilanoEnv>((DemogAnagrafeMilanoEnv)ei);
	}
