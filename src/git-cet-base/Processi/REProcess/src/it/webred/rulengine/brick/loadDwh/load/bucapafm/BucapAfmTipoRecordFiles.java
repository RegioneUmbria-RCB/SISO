...
public class BucapAfmTipoRecordFiles<T extends BucapAfmTipoRecordEnv<Testata>> extends ImportFilesWithTipoRecord<T> {
	
	public BucapAfmTipoRecordFiles(T env) {
		super(env);
	}//-------------------------------------------------------------------------
