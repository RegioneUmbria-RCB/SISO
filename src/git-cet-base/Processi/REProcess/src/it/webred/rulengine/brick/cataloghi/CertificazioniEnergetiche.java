 ...
 */
			...
			if (doInsert){
				...
				/*
				 * Definizione dei colori per layer cartografico CENED classe energetica:
					A = LIGHTGREEN
					A+ = GREEN
					B = HOTPINK
					C = PURPLE
				...
				if (aryClassiEnergetiche != null && aryClassiEnergetiche.size()>0){
					...
					for (int ind=0; ind<aryClassiEnergetiche.size(); ind++){
						...
						if (classeEner != null && classeEner.trim().equalsIgnoreCase("A")){
							colore = "lightgreen";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("Apiu")){
							colore = "green";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("B")){
							colore = "hotpink";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("C")){
							colore = "purple";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("D")){
							colore = "orangered";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("E")){
							colore = "brown";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("F")){
							colore = "blue";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("G")){
							colore = "navy";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("MIX")){
							colore = "black";
						}else if (classeEner != null && classeEner.trim().equalsIgnoreCase("-")){
							colore = "gray";
						}
