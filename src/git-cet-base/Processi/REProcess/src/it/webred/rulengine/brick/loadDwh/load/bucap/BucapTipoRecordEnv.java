...
public class BucapTipoRecordEnv<T extends Testata> extends EnvImportFilesWithTipoRecord<T> {
	...
	public BucapTipoRecordEnv(String connectionName, Context ctx) throws RulEngineException {
		super("51",connectionName, ctx);
	}
