...
public class ImportCurit extends Command implements Rule    {

	private static final org.apache.log4j.Logger log = Logger.getLogger(ImportCurit.class.getName());

	public ImportCurit(BeanCommand bc) {
		super(bc);
	}
	
	public ImportCurit(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
	...
	public CommandAck run(Context ctx) throws CommandException {
		...
		try {
			...
			T2<String, List<RAbNormal>> msg = curit.avviaImportazioneFiles();
			
			//se non ci sono file da elaborare NotFoundAck
			if(msg.firstObj.equals(curit.RETURN_NO_FILE)) {
