...
public interface ParameterService {
	...
	public List<AmKeyValueDTO> updateSelect(List<AmKeyValueDTO> listaDTO,String selected, int index);
	...
	public AmKeyValueExt getAmKeyValueExtByKeyFonteComune(String key, String comune,String fonte);
