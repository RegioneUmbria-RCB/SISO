...
public class LocazioniJPAImpl extends CTServiceBaseDAO implements LocazioniDAO {
	...
	@Override
	public List<Object[]> getImmobiliByCoordCat(RicercaLocazioniDTO rl) throws LocazioniServiceException {
		List<Object[]>  lista=null;
		logger.debug("LOCAZIONI IMMOBILI PER Coord Catastali[Foglio "+rl.getFoglio()+"];[particella "+rl.getParticella()+"]" );
		try {
			Query q = null;
			q = manager_diogene.createNamedQuery("Locazioni_B.getLocatariByCoordCat");
	...
	@Override
	public List<Object[]> getImmobiliByCodFis(RicercaLocazioniDTO rl) throws LocazioniServiceException {
		List<Object[]>  lista=null;
		logger.debug("LOCAZIONI IMMOBILI PER CF[codfisc "+rl.getCodFis()+"]" );
		try {
			Query q = null;
			q = manager_diogene.createNamedQuery("Locazioni_B.getLocatariByCFRes");
			q.setParameter("codfisc", rl.getCodFis());
			q.setParameter("dtRif",rl.getDtRif());
