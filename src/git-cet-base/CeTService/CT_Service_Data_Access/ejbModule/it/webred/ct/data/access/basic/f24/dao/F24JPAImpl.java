...
public class F24JPAImpl extends CTServiceBaseDAO implements F24DAO {
	...
	@Override
	public List<SitTF24Versamenti> getListaVersamentiByCFOrderByTipoAnnoTributo(String cf) {
			List<SitTF24Versamenti> lst = new ArrayList<SitTF24Versamenti>();
		
		try {

			logger.debug("getListaVersamentiByCFOrderByTipoAnnoTributo");
			Query q = manager_diogene.createNamedQuery("SitTF24Versamenti.getListaVersamentiByCFOrderByTipoAnnoTributo");
			q.setParameter("codfisc", cf.toUpperCase());
			...
			logger.error("getListaVersamentiByCFOrderByTipoAnnoTributo", t);
			throw new F24ServiceException(t);
		}
