...
public class DatiPersonaDTO extends AnagrafeBaseDTO implements Serializable{
	...
	private String codStatoRes; //SIGLA dello STATO (AM_TAB_NAZIONI)
	private String istatStatoRes; //COD.ISTAT dello STATO (AM_TAB_NAZIONI)
	...
	public String getIstatStatoRes() {
		return istatStatoRes;
	}
	public void setIstatStatoRes(String istatStatoRes) {
		this.istatStatoRes = istatStatoRes;
	}
	...
	public Date getDataInizioResidenza(){
		return infoAggiuntive.getCivico()!=null ? this.infoAggiuntive.getCivico().getDtInizioVal() : null;
	}
