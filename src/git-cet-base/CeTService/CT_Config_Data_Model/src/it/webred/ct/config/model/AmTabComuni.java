...
public class AmTabComuni implements Serializable {
	...
	@OneToOne
	@JoinColumn(name="COD_ISTAT_REGIONE", insertable=false, updatable=false)
	private AmTabRegioni regione;
	...
	public AmTabRegioni getRegione() {
		return regione;
	}

	public void setRegione(AmTabRegioni regione) {
