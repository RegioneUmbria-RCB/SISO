...
public class LocazioniA implements Serializable {
	...
	public BigDecimal getImportoCanoneFormatted() {
		if (this.getImportoCanone()!=null && this.getImportoCanone().length()>0){
			return new BigDecimal(this.getImportoCanone()).divide(new BigDecimal(100));
		}else{
			return null;
		}
	}
