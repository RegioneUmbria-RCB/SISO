...
/**
 * The persistent class for the SIT_T_ICI_CONTRIB database table.
 * 
 */
@Entity
@Table(name="SIT_T_ICI_CONTIT")
public class SitTIciContit implements Serializable {
	...
	@Column(name="ID_EXT_SOGG")
	private String idExtSogg;
	...
	public String getIdExtSogg() {
		return this.idExtSogg;
	}

	public void setIdExtSogg(String idExtSogg) {
		this.idExtSogg = idExtSogg;
	}
