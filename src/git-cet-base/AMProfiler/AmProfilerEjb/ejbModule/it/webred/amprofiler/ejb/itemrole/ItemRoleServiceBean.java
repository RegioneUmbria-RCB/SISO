...
public class ItemRoleServiceBean extends AmProfilerBaseService implements
	...
	public List<String> findPermissionByEnteItemUsername(String ente,
		...
		try {
			...
			Query q = em.createNativeQuery(new QueryBuilder().createQueryPermessiByEnteItemUsername(null));
			q.setParameter("ente", ente);
			q.setParameter("applicationItem", applicationItem);
			q.setParameter("username", username);
	...
	public List<String> findPermissionByEnteItemUsername(String ente,
		...
		try {
			...
			Query q = em.createNativeQuery(new QueryBuilder().createQueryPermessiByEnteItemUsername(gruppi));
			q.setParameter("ente", ente);
			q.setParameter("applicationItem", applicationItem);
			q.setParameter("username", username);
