...
@Stateless
public class AnagraficaServiceBean extends AmProfilerBaseService implements AnagraficaService {

	@Override
	public List<AmAnagrafica> getListaAnagrafica(AnagraficaSearchCriteria criteria) {
		List<AmAnagrafica> list = new ArrayList<AmAnagrafica>();
		try {
			...
			q.setMaxResults(criteria.getMaxResult());
			qb.setParameters(q);
