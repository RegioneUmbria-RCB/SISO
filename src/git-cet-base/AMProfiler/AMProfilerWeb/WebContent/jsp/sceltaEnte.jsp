		              	...
		              	<table style="width: 100%; border-width: 0px;">
		              		...
		              		<tr>
		              			<td style="width: 100%; text-align: center; border-width: 0px; font-style: italic; padding-top: 10px;">
		              				<input name="ragioneAccesso" type="text" maxlength="25" style="width: 250px;" value="<c:out value='${ragioneAccesso}'/>"/>
		              			</td>
		              		</tr>
		              		<tr>
		              			<td style="width: 100%; text-align: center; border-width: 0px; font-weight: bold;">
		              		...
		              		<tr>
		              			<td style="width: 100%; text-align: center; border-width: 0px; font-style: italic; padding-top: 10px;">
		              				<input name="pratica" type="text" maxlength="20" style="width: 200px;" value="<c:out value='${praticaAccesso}'/>"/>
		              			</td>
		              		</tr>
		              		<tr>
		              			<td style="width: 100%; text-align: center; border-width: 0px; font-style: italic; padding-top: 10px;">
		              		...
		              		<tr>
		              			<td style="width: 100%; text-align: center; border-width: 0px; font-style: italic; padding-top: 10px;">
		              				<input type="radio" name="rdoMotivoAccesso" id="rdoMotivoAccesso" value="STANDARD" <c:if test="${rdoMotivoAccesso=='STANDARD'}">checked</c:if> >Accedi alla piattaforma GIT specificando ogni volta il motivo di accesso e la pratica<br>
									<input type="radio" name="rdoMotivoAccesso" id="rdoMotivoAccessoUltimo" value="LAST" <c:if test="${rdoMotivoAccesso=='LAST'}">checked</c:if> >Accedi alla piattaforma GIT usando l'ultima motivazione specificata e dando conferma<br>
									<input type="radio" name="rdoMotivoAccesso" id="rdoMotivoAccessoSalta" value="SKIP" <c:if test="${rdoMotivoAccesso=='SKIP'}">checked</c:if> >Accedi alla piattaforma GIT usando sempre l'ultima motivazione specificata senza dare conferma<br>
		              			</td>
		              		</tr>
		              	</table>
		              </td>
