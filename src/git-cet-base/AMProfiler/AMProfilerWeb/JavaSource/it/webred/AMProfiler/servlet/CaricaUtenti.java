	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			for(AmAnagrafica an: listaAnagrafica){
				...
				if(an.getAmUser()!=null && BaseAction.checkUserVisible(loggedUser, an.getAmUser().getName())){
					...
					if(ricerca.getStato() != null && ricerca.getStato().contains("PWD")){
						if(ricerca.getStato().equals("PWD VALID") && dto.getStatoPwd().contains("Valida"))
							listaAnagraficaDTO.add(dto);
						if(ricerca.getStato().equals("PWD ABOUT TO EXPIRE") && dto.getStatoPwd().contains("In scadenza"))
							listaAnagraficaDTO.add(dto);
						if(ricerca.getStato().equals("PWD EXPIRED") && dto.getStatoPwd().contains("Scaduta"))
							listaAnagraficaDTO.add(dto);
					}else
						listaAnagraficaDTO.add(dto);
				}
