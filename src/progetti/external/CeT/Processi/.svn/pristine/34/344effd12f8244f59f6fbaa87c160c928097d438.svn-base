...
import it.webred.rulengine.brick.loadDwh.load.redditi.r2016.RedditiFiles;
...
public class ImportRedditi2016Rule  extends Command implements Rule {
	private static Logger log = Logger.getLogger(ImportRedditi2016Rule.class.getName());

	public ImportRedditi2016Rule(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
