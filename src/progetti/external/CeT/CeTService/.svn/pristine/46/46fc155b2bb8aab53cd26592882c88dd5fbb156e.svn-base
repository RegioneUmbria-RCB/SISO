...
public class AuditServiceBean implements
	...
	public List<AuditDTO> getListaAmAudit(AuditSearchCriteria criteria, Integer start, Integer rowNumber) {
	...
	@Override
	public AmAudit findAuditBySessionId(String sessionId) {
		try{
			Query q = manager.createNamedQuery("Audit.findAuditBySessionID");
			q.setParameter("sessionId", sessionId);
			List<AmAudit> lst = q.getResultList();
