...
public class ComuneQueryBuilder extends AbstractQueryBuilder{
	...
	public static final String SQL_LISTA_COMUNI_BY_USER = 
	...
	public static final String SQL_LISTA_INSTANCE_COMUNI = 
	...
	public static final String SQL_LISTA_FONTE_COMUNI = 
