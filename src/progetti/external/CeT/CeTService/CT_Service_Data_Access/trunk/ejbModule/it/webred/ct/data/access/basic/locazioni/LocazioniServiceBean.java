...
public class LocazioniServiceBean extends CTServiceBaseBean implements	LocazioniService {
	...
	@Override
	public List<Object[]> getImmobiliByCoordCat(RicercaLocazioniDTO rl) {
		return locazioniDAO.getImmobiliByCoordCat(rl); 
	}
	@Override
	public List<Object[]> getImmobiliByCodFis(RicercaLocazioniDTO rl) {
		return locazioniDAO.getImmobiliByCodFis(rl);
	}
