...
public class AbitazioneManBean extends AbitazioneManBaseBean{
	...
	public String getStruttura() {
		return getJsonCurrent().getStruttura();
	}

	@Override
	public void setStruttura(String struttura) {
		this.getJsonCurrent().setStruttura(struttura);
	}

	@Override
	public String getArea() {
		return getJsonCurrent().getArea();
	}

	@Override
	public void setArea(String area) {
		this.getJsonCurrent().setArea(area);
		
	}
	
	@Override
	public String getUnitaAbitativa() {
		return getJsonCurrent().getUnitaAbitativa();
	}

	@Override
	public void setUnitaAbitativa(String unitaAbitativa) {
		this.getJsonCurrent().setUnitaAbitativa(unitaAbitativa);
		
	}
	
	@Override
	public boolean isVisualizzaStruttura() {
		return CsUiCompBaseBean.isRilevazionePresenzeAbilita();
	}
