...
public class SsIndirizzo implements Serializable {
	...
	//STAMPA
	public String getStampaDesIndirizzo() {
		String descrizione = "";
		String comuneStato = "";
		descrizione += this.strutturaAccoglienza !=null ? "(Struttura di accoglienza: "+strutturaAccoglienza+") " :"";
	
		comuneStato =  !StringUtils.isEmpty(this.comuneDes) ? this.comuneDes+" ("+this.getProvCod()+")" : "" ;
		comuneStato += (!comuneStato.isEmpty() && this.statoCod!=null) ? " - " : "";
		comuneStato += !StringUtils.isEmpty(this.statoCod) ? this.statoDes : "";
		descrizione += !StringUtils.isEmpty(this.via) ? this.via : ""; 
