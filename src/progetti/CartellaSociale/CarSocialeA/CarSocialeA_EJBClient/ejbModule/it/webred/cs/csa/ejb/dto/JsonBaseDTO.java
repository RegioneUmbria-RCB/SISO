...
public class JsonBaseDTO extends BaseDTO {
	...
	public Long getVisSecLivello() {
		return visSecLivello;
	}
	public void setVisSecLivello(Long visSecLivello) {
		this.visSecLivello = visSecLivello;
	}
