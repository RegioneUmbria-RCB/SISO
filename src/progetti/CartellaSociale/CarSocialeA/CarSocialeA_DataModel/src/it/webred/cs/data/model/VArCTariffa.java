...
@NamedQueries(value={
		@NamedQuery(name="VArCTariffa.findAll", query="SELECT v FROM VArCTariffa v"),
	    @NamedQuery(name = "VArCTariffa.findTariffaById", query="SELECT v FROM VArCTariffa v WHERE v.id = :id "),
	    @NamedQuery(name = "VArCTariffa.findTariffaByOrganizzazione", query="SELECT v FROM VArCTariffa v WHERE v.codRouting = :codRouting"),
	    @NamedQuery(name = "VArCTariffa.findTariffaByUMeOrg",query="SELECT v FROM VArCTariffa v WHERE v.unitaMisuraId = :unitaMisuraId and v.codRouting = :codRouting")
	})
