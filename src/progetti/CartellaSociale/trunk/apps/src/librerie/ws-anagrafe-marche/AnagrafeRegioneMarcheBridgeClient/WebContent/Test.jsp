...
<body>
	...
	RicercaAnagraficaClient rc = new RicercaAnagraficaClient("C:\\progetti\\SISO\\ANAGRAFE_MARCHE_SISO-927\\CertNew\\cacerts.jks","changeit"); 
	...
	out.print("<br/>");
	Integer i = 1;
	ArrayList<PersonaResult> ListaPersoneResult  = rpr.getElencoAssisiti();
