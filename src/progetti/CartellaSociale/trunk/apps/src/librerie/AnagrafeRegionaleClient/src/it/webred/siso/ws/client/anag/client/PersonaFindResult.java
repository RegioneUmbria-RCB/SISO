...
public class PersonaFindResult {
	...
	private String medicoDataScelta;
	private String medicoDataRevoca;
	...
	public Date getDataMor() {
		return convertiData(this.dataMor);
	}
	...
	public Date getMedicoDataScelta() {
		return convertiData(medicoDataScelta);
	}
	...
	public Date getMedicoDataRevoca() {
		return convertiData(this.medicoDataRevoca);
	}
	...
	private Date convertiData(String sdata){
