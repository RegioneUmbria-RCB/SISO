...
/**
 * <p>Java class for COCT_MT050000UV.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT050000UV.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asPatientOfOtherProvider" type="{urn:hl7-org:v3}COCT_MT050000UV.PatientOfOtherProvider" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asEmployee" type="{urn:hl7-org:v3}COCT_MT050000UV.Employee" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCitizen" type="{urn:hl7-org:v3}COCT_MT050000UV.Citizen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}COCT_MT050000UV.Student" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}COCT_MT050000UV.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}COCT_MT050000UV.OtherIDs" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="contactParty" type="{urn:hl7-org:v3}COCT_MT050000UV.ContactParty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guardian" type="{urn:hl7-org:v3}COCT_MT050000UV.Guardian" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="personalRelationship" type="{urn:hl7-org:v3}COCT_MT050000UV.PersonalRelationship" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="careGiver" type="{urn:hl7-org:v3}COCT_MT050000UV.CareGiver" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthPlace" type="{urn:hl7-org:v3}COCT_MT050000UV.BirthPlace" minOccurs="0"/>
 *         &lt;element name="guarantorRole" type="{urn:hl7-org:v3}COCT_MT670000UV04.GuarantorRole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_MT050000UV.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT050000UV.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class COCTMT050000UVPerson {
    ...
    protected List<COCTMT050000UVPatientOfOtherProvider> asPatientOfOtherProvider;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVEmployee> asEmployee;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVCitizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVStudent> asStudent;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVMember> asMember;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVOtherIDs> asOtherIDs;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVGuardian> guardian;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVPersonalRelationship> personalRelationship;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVCareGiver> careGiver;
    @XmlElementRef(name = "birthPlace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT050000UVBirthPlace> birthPlace;
    @XmlElement(nillable = true)
    protected List<COCTMT670000UV04GuarantorRole> guarantorRole;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UVLanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVPatientOfOtherProvider }
     * 
     * 
     */
    public List<COCTMT050000UVPatientOfOtherProvider> getAsPatientOfOtherProvider() {
        if (asPatientOfOtherProvider == null) {
            asPatientOfOtherProvider = new ArrayList<COCTMT050000UVPatientOfOtherProvider>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVEmployee }
     * 
     * 
     */
    public List<COCTMT050000UVEmployee> getAsEmployee() {
        if (asEmployee == null) {
            asEmployee = new ArrayList<COCTMT050000UVEmployee>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVCitizen }
     * 
     * 
     */
    public List<COCTMT050000UVCitizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<COCTMT050000UVCitizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVStudent }
     * 
     * 
     */
    public List<COCTMT050000UVStudent> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<COCTMT050000UVStudent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVMember }
     * 
     * 
     */
    public List<COCTMT050000UVMember> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<COCTMT050000UVMember>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVOtherIDs }
     * 
     * 
     */
    public List<COCTMT050000UVOtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<COCTMT050000UVOtherIDs>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVContactParty }
     * 
     * 
     */
    public List<COCTMT050000UVContactParty> getContactParty() {
        if (contactParty == null) {
            contactParty = new ArrayList<COCTMT050000UVContactParty>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVGuardian }
     * 
     * 
     */
    public List<COCTMT050000UVGuardian> getGuardian() {
        if (guardian == null) {
            guardian = new ArrayList<COCTMT050000UVGuardian>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVPersonalRelationship }
     * 
     * 
     */
    public List<COCTMT050000UVPersonalRelationship> getPersonalRelationship() {
        if (personalRelationship == null) {
            personalRelationship = new ArrayList<COCTMT050000UVPersonalRelationship>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVCareGiver }
     * 
     * 
     */
    public List<COCTMT050000UVCareGiver> getCareGiver() {
        if (careGiver == null) {
            careGiver = new ArrayList<COCTMT050000UVCareGiver>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT050000UVBirthPlace }{@code >}
     *     
     */
    public JAXBElement<COCTMT050000UVBirthPlace> getBirthPlace() {
        return birthPlace;
    }
     ...
     *     
     */
    public void setBirthPlace(JAXBElement<COCTMT050000UVBirthPlace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UVLanguageCommunication }
     * 
     * 
     */
    public List<COCTMT050000UVLanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTMT050000UVLanguageCommunication>();
        }
