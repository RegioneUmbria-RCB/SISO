...
public class DatiCasoBean {
	...
	public DatiCasoBean(CsASoggettoLAZY soggetto, List<CsACasoOpeTipoOpe> operatori, IterInfoStatoMan lastIterStepInfo, List<CsACasoAccessoFascicolo> operatori2, String residenza){
