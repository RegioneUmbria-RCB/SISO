...
public class CsUiCompBaseBean {
	...
	public String getZonaSociale() {
		try {
			AccessTableOperatoreSessionBeanRemote opService = (AccessTableOperatoreSessionBeanRemote)getCarSocialeEjb("AccessTableOperatoreSessionBean");
			BaseDTO dto = new BaseDTO();
			fillEnte(dto);
...
//FINE MOD-RL
	...
	private static String getLabelUDC(String tab){
