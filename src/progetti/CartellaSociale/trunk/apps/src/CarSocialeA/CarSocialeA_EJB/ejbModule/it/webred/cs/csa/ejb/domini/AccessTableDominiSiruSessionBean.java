...
public class AccessTableDominiSiruSessionBean extends CarSocialeBaseSessionBean  implements AccessTableDominiSiruSessionBeanRemote {
	...
	public void initDominiSingleton(){
		...
		//SISO DOMINI
		cache.put(SiruEnum.AM_NAZIONALITA.name(), dominioDAO.loadAmNazionalita(luoghiService));
		cache.put(SiruEnum.AM_NAZIONE_AG_ENTRATE.name(), dominioDAO.loadAmNazioneAgEntrate(luoghiService));
