...
public class OperatoriTableDataModel extends LazyDataModel<DatiOperatore> implements SelectableDataModel<DatiOperatore> {
	...
	private String filtroAbilitato;
	  ...
	  public List<DatiOperatore> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map filters) {
		 ...
		 AccessTableOperatoreSessionBeanRemote operatoreService = (AccessTableOperatoreSessionBeanRemote) CsUiCompBaseBean.getCarSocialeEjb("AccessTableOperatoreSessionBean");
				...
				if(amAna != null) {
					...
					for(String b : entib){
						...
						if(map.containsKey(b))
						    ...
						    dto.setObj(b);
						    o = confService.getOrganizzazioneByCodFittizio(dto);
						    map.put(b, o);
						}
