...
public class RelazioniStampaFiller extends CsUiCompBaseBean {
	...
	private AccessTableOperatoreSessionBeanRemote operatoreService = (AccessTableOperatoreSessionBeanRemote)getCarSocialeEjb("AccessTableOperatoreSessionBean");
...
public RelazionePdfDTO fillRelazioni() {
		...
		for(CsDIsee d :lstdiario){
				if(d.getCsDDiario().getDtChiusuraDa()!=null && d.getCsDDiario().getDtChiusuraDa().after(n))
