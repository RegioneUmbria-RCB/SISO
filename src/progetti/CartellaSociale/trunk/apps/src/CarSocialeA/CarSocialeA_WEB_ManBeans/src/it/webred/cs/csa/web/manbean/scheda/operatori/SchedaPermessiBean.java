		...
		try {
			...
			if(this.idEnte!=null){
				...
				if(this.gestisciPermessi == null || this.gestisciPermessi.equals(OPERATORI)){
					beanLst=operatoreService.findSettoreBASICByOrganizzazione(dto);
				}else if(this.gestisciPermessi != null && this.gestisciPermessi.equals(SECONDOLIVELLO)){
					beanLst=operatoreService.findSettoreBASICSecondoLivelloByOrganizzazione(dto);
				}else //gestisciPermessi uguale a ORGANIZZAZIONE
					beanLst=operatoreService.findSettoreBASICSenzaSecondoLivelloByOrganizzazione(dto);
