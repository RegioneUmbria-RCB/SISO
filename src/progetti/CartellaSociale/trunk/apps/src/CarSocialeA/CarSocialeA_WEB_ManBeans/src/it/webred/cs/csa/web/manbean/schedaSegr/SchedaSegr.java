...
public class SchedaSegr{
	...
	public SsCCategoriaSociale getCategoriaSociale(){
		if(this.ssScheda.getLstCategorieSociali()!=null && !this.ssScheda.getLstCategorieSociali().isEmpty())
			return this.ssScheda.getLstCategorieSociali().get(0);
		return null;
	}
