...
public interface AccessTablePsExportSessionBeanRemote {
	...
	public List<CsIPsExport> findCsIPsExportByCsIInterventoEseg(BaseDTO dto); //SISO-884
	
	public void deleteCsIPsExportByIntEsegIdAndIntEsegMastId(BaseDTO dto); //SISO-884
	
	public void deleteCsIPsExportMastById(BaseDTO dto); //SISO - 884
	
	public List<CsIPsExportMast> findCsIPsExportMastByIds(BaseDTO dto); //SISO - 884
