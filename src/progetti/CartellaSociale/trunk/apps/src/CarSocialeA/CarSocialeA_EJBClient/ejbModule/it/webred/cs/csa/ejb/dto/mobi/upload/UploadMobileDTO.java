...
public class UploadMobileDTO implements Serializable {
	...
	//TASK SISO-777
	private UploadMobileAttivitaProfessionaliDTO[] attivitaProfessionali;
	...
	//TASK SISO-777
	public UploadMobileAttivitaProfessionaliDTO[] getAttivitaProfessionali() {
		return attivitaProfessionali;
	}
	public void setAttivitaProfessionali(
			UploadMobileAttivitaProfessionaliDTO[] attivitaProfessionali) {
		this.attivitaProfessionali = attivitaProfessionali;
	}
