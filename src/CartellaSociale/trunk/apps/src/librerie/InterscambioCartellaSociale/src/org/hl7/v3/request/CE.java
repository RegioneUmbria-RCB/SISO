 ...
 *       &lt;/sequence>
 *       &lt;attribute name="code" type="{urn:hl7-org:v3}st" />
...
@XmlType(name = "CE")
@XmlSeeAlso({
    org.hl7.v3.request.COCTMT030000ZZPerson.AdministrativeGenderCode.class,
    org.hl7.v3.request.COCTMT030000ZZPerson.MaritalStatusCode.class,
    HXITCE.class,
    CV.class,
    EIVLEvent.class
})
