...
/**
 * <p>Java class for COCT_MT030200UV08.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT030200UV08.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asEmployee" type="{urn:hl7-org:v3}COCT_MT030200UV08.Employee" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCitizen" type="{urn:hl7-org:v3}COCT_MT030200UV08.Citizen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}COCT_MT030200UV08.Student" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}COCT_MT030200UV08.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}COCT_MT030200UV08.OtherIDs" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="contactParty" type="{urn:hl7-org:v3}COCT_MT030200UV08.ContactParty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guardian" type="{urn:hl7-org:v3}COCT_MT030200UV08.Guardian" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="personalRelationship" type="{urn:hl7-org:v3}COCT_MT030200UV08.PersonalRelationship" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="careGiver" type="{urn:hl7-org:v3}COCT_MT030200UV08.CareGiver" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthPlace" type="{urn:hl7-org:v3}COCT_MT030200UV08.BirthPlace" minOccurs="0"/>
 *         &lt;element name="guarantorRole" type="{urn:hl7-org:v3}COCT_MT670000UV04.GuarantorRole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_MT030200UV08.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT030200UV08.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class COCTMT030200UV08Person {
    ...
    protected List<COCTMT030200UV08Employee> asEmployee;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08Citizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08Student> asStudent;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08Member> asMember;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08OtherIDs> asOtherIDs;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08ContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08Guardian> guardian;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08PersonalRelationship> personalRelationship;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08CareGiver> careGiver;
    @XmlElementRef(name = "birthPlace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT030200UV08BirthPlace> birthPlace;
    @XmlElement(nillable = true)
    protected List<COCTMT670000UV04GuarantorRole> guarantorRole;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UV08LanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08Employee }
     * 
     * 
     */
    public List<COCTMT030200UV08Employee> getAsEmployee() {
        if (asEmployee == null) {
            asEmployee = new ArrayList<COCTMT030200UV08Employee>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08Citizen }
     * 
     * 
     */
    public List<COCTMT030200UV08Citizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<COCTMT030200UV08Citizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08Student }
     * 
     * 
     */
    public List<COCTMT030200UV08Student> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<COCTMT030200UV08Student>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08Member }
     * 
     * 
     */
    public List<COCTMT030200UV08Member> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<COCTMT030200UV08Member>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08OtherIDs }
     * 
     * 
     */
    public List<COCTMT030200UV08OtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<COCTMT030200UV08OtherIDs>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08ContactParty }
     * 
     * 
     */
    public List<COCTMT030200UV08ContactParty> getContactParty() {
        if (contactParty == null) {
            contactParty = new ArrayList<COCTMT030200UV08ContactParty>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08Guardian }
     * 
     * 
     */
    public List<COCTMT030200UV08Guardian> getGuardian() {
        if (guardian == null) {
            guardian = new ArrayList<COCTMT030200UV08Guardian>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08PersonalRelationship }
     * 
     * 
     */
    public List<COCTMT030200UV08PersonalRelationship> getPersonalRelationship() {
        if (personalRelationship == null) {
            personalRelationship = new ArrayList<COCTMT030200UV08PersonalRelationship>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08CareGiver }
     * 
     * 
     */
    public List<COCTMT030200UV08CareGiver> getCareGiver() {
        if (careGiver == null) {
            careGiver = new ArrayList<COCTMT030200UV08CareGiver>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT030200UV08BirthPlace }{@code >}
     *     
     */
    public JAXBElement<COCTMT030200UV08BirthPlace> getBirthPlace() {
        return birthPlace;
    }
     ...
     *     
     */
    public void setBirthPlace(JAXBElement<COCTMT030200UV08BirthPlace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UV08LanguageCommunication }
     * 
     * 
     */
    public List<COCTMT030200UV08LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTMT030200UV08LanguageCommunication>();
        }
