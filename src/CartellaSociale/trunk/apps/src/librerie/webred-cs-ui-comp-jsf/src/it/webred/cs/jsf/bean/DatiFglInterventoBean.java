...
public class DatiFglInterventoBean extends CsUiCompBaseBean implements Serializable {	
	...
	public boolean isChiusura(){
		return DataModelCostanti.FoglioAmministrativo.STATO_CHIUSURA.equalsIgnoreCase(this.flagAttivazione);
	}
	public boolean isValutazione(){
		return DataModelCostanti.FoglioAmministrativo.STATO_VALUTAZIONE.equalsIgnoreCase(this.flagAttivazione);
	}
}
