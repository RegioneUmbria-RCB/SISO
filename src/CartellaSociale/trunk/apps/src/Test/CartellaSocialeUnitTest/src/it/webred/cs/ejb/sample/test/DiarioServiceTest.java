...
public class DiarioServiceTest {
    ...
    private static AccessTableDiarioSessionBeanRemote lookupRemoteEJB() throws NamingException {
    	AccessTableDiarioSessionBeanRemote ejb = ClientUtility.getEJBInterfaceForSTANDALONERemoteClient(AccessTableDiarioSessionBeanRemote.class , "CarSocialeA", "CarSocialeA_EJB", "AccessTableDiarioSessionBean", "");
