...
public class InterscambioCartellaSocialeBean extends CsUiCompBaseBean {
	...
	/**
	 * Valorizza nel bean il caso selezionato che sar� mostrato nel MODAL
	 * 
	 * @param caso
	 */
	...
	public void importaFile(FileUploadEvent event) {
		 ...
		 * il salvataggio � avvenuto correttamente.
		 * 
		 * Si pu� supporre che getContents restituisca byte[] in UTF-8.
		 */
