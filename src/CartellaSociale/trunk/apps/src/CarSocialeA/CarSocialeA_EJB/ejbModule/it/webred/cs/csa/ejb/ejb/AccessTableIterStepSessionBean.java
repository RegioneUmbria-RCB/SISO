...
*/
	...
	private void addAlert(IterDTO dto) throws Exception {
		...
		newAlert.setUserId(dto.getUserId());
		newAlert.setEnteId(dto.getEnteId());
		newAlert.setSessionId(dto.getSessionId());
	    	   ...
	    	   for(CsASoggettoLAZY soggetto : soggetti){
	    		   ...
	    		   IterDTO itr = new IterDTO();
	   			   ...
	   			   if(stato!=null){
	   				  ...
	   				  String organizzazione = stato.getCsItStep().getCsOOrganizzazione1().getBelfiore()!=null ? "Comune di " : "";
