...
public class AccessTableConfigurazioneSessionBean extends CarSocialeBaseSessionBean implements AccessTableConfigurazioneSessionBeanRemote {
    ...
    public CsTbTipoAbitazione getParamAbitazione(BaseDTO dto){
    	return configurazioneDAO.getLabeTipoAbit((String) dto.getObj());
    }
    @Override
    public CsTbAbitTitoloGodimento getParamTitoloGod(BaseDTO dto){
    	return configurazioneDAO.getLabeTitoloGodimento((String) dto.getObj());
    }
   ...
   public CsOOrganizzazione getOrganizzazioneCapofila(CeTBaseObject cet) {
	...
	public List<ArTbPrestazioniInps> getPrestazioniInpsSina(BaseDTO dto) {
		return configurazioneDAO.getPrestazioniInpsSina();
	}
