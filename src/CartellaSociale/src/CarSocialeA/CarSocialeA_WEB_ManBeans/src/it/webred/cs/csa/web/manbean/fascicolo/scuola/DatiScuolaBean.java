...
public class DatiScuolaBean extends FascicoloCompBaseBean implements IDatiScuola {
	...
	public void nuovo() {
		...
		listaNomi.add(new SelectItem("0", "-> Scegli"));
	...
	public List<SelectItem> getListaComuni() {
		if(listaComuni == null) {
			...
			listaComuni.add(new SelectItem("", "-> Scegli"));
	...
	public List<SelectItem> getListaTipi() {
		if(listaTipi == null) {
			...
			listaTipi.add(new SelectItem("0", "-> Scegli"));
	...
	public List<SelectItem> getListaProgetti() {
		if (listaProgetti == null) {
			...
			listaProgetti.add(new SelectItem("", "-> Scegli"));
			CeTBaseObject cet = new CeTBaseObject();
			fillEnte(cet);
