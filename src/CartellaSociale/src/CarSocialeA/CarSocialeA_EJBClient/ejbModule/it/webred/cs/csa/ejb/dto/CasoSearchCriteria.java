...
public class CasoSearchCriteria implements Serializable{
	...
	private boolean soloOperatoreNR=false;
	...
	public boolean isSoloOperatoreNR() {
		return soloOperatoreNR;
	}

	public void setSoloOperatoreNR(boolean soloOperatoreNR) {
		this.soloOperatoreNR = soloOperatoreNR;
	}
