...
public class SchedaDAO extends CarSocialeBaseDAO implements Serializable {
	...
	//Caso operatore Tipo Operatore
	
	@SuppressWarnings("unchecked")
	public List<CsACasoOpeTipoOpe> findCasoOpeTipoOpeByCasoId(Long casoId){
		
		Query cs = em.createNamedQuery("CsACasoOpeTipoOpe.findCasoOpeTipoOpebyCasoId").setParameter("casoId", casoId);
		return cs.getResultList();
	}
