package it.webred.cs.jsf.bean.SearchTipoIntervento;
...
public class TreeController extends CsUiCompBaseBean {
	...
	protected void setSelectedNode(Long id)
	{
		TreeNode currentNode = searchNode(id);
		if (currentNode != null)
		{
	...
	private TreeNode createTreeCustomNode(VGerrarchiaServizi gServ, TreeNode parent)
	{
		...
		node = new DefaultTreeNode(new TreeNodeBean(gServ, isSelectable, icon), parent);
