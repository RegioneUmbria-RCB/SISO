...
public class ClientUtility {
   ...
   // 	pr.put("remote.connection.default.password", "ejb12u");
     ...
     */
    @SuppressWarnings({ "unused", "rawtypes", "unchecked" })
	public  static <ejbRemoteInterfaceClass> ejbRemoteInterfaceClass getEJBInterfaceForRemoteClient(Class<ejbRemoteInterfaceClass> ejbRemoteInterfaceClass, String appName, String moduleName, String EJBName, String distinctName, String host) throws NamingException {
    	Properties pr = new Properties();
