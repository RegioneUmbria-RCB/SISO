...
/**
 * <p>Java class for COCT_MT090400UV.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT090400UV.Person">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{urn:hl7-org:v3}InfrastructureRootElements"/>
 *         &lt;element name="name" type="{urn:hl7-org:v3}EN" maxOccurs="unbounded"/>
 *         &lt;element name="asLicensedEntity" type="{urn:hl7-org:v3}COCT_MT090400UV.LicensedEntity" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}COCT_MT090400UV.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asRoleOther" type="{urn:hl7-org:v3}COCT_MT090400UV.RoleOther" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asLocatedEntity" type="{urn:hl7-org:v3}COCT_MT070000UV01.LocatedEntity" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_MT090400UV.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT090400UV.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "name",
...
public class COCTMT090400UVPerson {
    ...
    protected List<COCTMT090400UVLicensedEntity> asLicensedEntity;
    @XmlElement(nillable = true)
    protected List<COCTMT090400UVMember> asMember;
    @XmlElement(nillable = true)
    protected List<COCTMT090400UVRoleOther> asRoleOther;
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT090400UVLanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090400UVLicensedEntity }
     * 
     * 
     */
    public List<COCTMT090400UVLicensedEntity> getAsLicensedEntity() {
        if (asLicensedEntity == null) {
            asLicensedEntity = new ArrayList<COCTMT090400UVLicensedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090400UVMember }
     * 
     * 
     */
    public List<COCTMT090400UVMember> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<COCTMT090400UVMember>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090400UVRoleOther }
     * 
     * 
     */
    public List<COCTMT090400UVRoleOther> getAsRoleOther() {
        if (asRoleOther == null) {
            asRoleOther = new ArrayList<COCTMT090400UVRoleOther>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090400UVLanguageCommunication }
     * 
     * 
     */
    public List<COCTMT090400UVLanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTMT090400UVLanguageCommunication>();
        }
