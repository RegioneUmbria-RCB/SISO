...
public class ValMultidimensionaleController extends JsonExtController<ValMultidimensionaleBean> {

	private static final long serialVersionUID = 1L;

	@Override
	public String getDescrizioneScheda() {
		return ((ValMultidimensionaleBean)getJsonCurrent()).getDescrizioneScheda();
	}

	@Override
	public int getTipoDiarioId() {
		return DataModelCostanti.TipoDiario.VALUTAZIONE_MDS_ID;
	}
	
	@Override
	public Date getDtAmministrativa() {
		return ((ValMultidimensionaleBean)getJsonCurrent()).getDataValutazione();
	}
