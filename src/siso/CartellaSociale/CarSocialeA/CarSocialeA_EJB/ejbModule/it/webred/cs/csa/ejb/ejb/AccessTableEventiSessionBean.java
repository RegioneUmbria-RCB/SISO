...
public class AccessTableEventiSessionBean extends CarSocialeBaseSessionBean implements AccessTableEventiSessionBeanRemote {
	...
	public void creaEvento(EventoDTO nuovoEventoDTO) {
		...
		operatoreSettore.setId(nuovoEventoDTO.getOperatore().getIdOperatoreSettore());
