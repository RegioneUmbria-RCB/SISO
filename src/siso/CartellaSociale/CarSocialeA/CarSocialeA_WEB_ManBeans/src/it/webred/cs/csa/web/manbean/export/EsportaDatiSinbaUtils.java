...
public class EsportaDatiSinbaUtils {
	
	public static Logger logger = Logger.getLogger("carsociale.log");


//@formatter:off
	public static File esportaDatiSinba(
														String XML_PATH,
...
//@formatter:on
		...
		SinbaXmlExporter xmlExporter = SinbaExportFactory.getExporter(schemaVersion);
		if (xmlExporter == null)
...
//      <Carattere>1</Carattere>
		esportazioneDTO.setCarattere(DataModelCostanti.CSIPs.CARATTERE_PRESTAZIONE_DI_TIPO_PERIODICO);
...
//        <Carattere>2</Carattere>
		esportazioneDTO.setCarattere(DataModelCostanti.CSIPs.CARATTERE_PRESTAZIONE_DI_TIPO_OCCASIONALE);
//        <NumeroProtocolloDSU>INPS-ISEE-2015-01480722D-00</NumeroProtocolloDSU>
...
//fine SISO-538	
	...
	public static List<EsportazioneTestataDTO> costruisciListaTestateErogazione(
		...
		if (giaInviateList != null) {
			for (EsportazioneDTOView erogazioneGiaInviata : giaInviateList) {
				String causale = String.format(
						"Erogazione esportata in data %s",
						erogazioneGiaInviata.dataEsportazioneFormatShort());
