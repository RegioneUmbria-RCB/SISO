...
public class CsCfgIntEsegStato implements Serializable {
	...
	@Column(name="FLAG_CHIUDI")
	private Boolean flagChiudi;	  //SISO-556 
...
/*	public List<CsCfgIntEseg> getCsCfgIntEseg() {
	...
	public Integer getOrdineDescFase() {
		return ordineDescFase;
	}

	public void setOrdineDescFase(Integer ordineDescFase) {
		this.ordineDescFase = ordineDescFase;
	}
