...
public class CsIPs implements Serializable{
	...
	//SISO-962
	@Column(name="BENEFICIARIO_COD_CITTADI_2")
	private Integer benefCittadinanza2;
	...
	//SISO-722
	public Integer getFlagInCarico() {
		return flagInCarico;
	}

	public void setFlagInCarico(Integer flagInCarico) {
	...
	public boolean isSituazioneEconomicaVerificata() {  
		if (this.getFlagProvaMezzi()!=null) { 
			return this.getFlagProvaMezzi() ==  PROVA_MEZZI.ISEE_E_PROVA_MEZZI.getCodice()  || 
				   this.getFlagProvaMezzi() ==  PROVA_MEZZI.ISEE_NON_PROVA_MEZZI.getCodice() ;
		} else
			return false;
	}

	public Integer getBenefCittadinanza2() {
		return benefCittadinanza2;
	}

	public void setBenefCittadinanza2(Integer benefCittadinanza2) {
		this.benefCittadinanza2 = benefCittadinanza2;
	}
	
	public void resetDatiIsee(){
		this.annoProtDSU=null;
		this.dataDSU=null;
		this.numProtDSU=null;
		this.progProtDSU=null;
	}
