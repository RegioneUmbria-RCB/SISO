...
public class CsOOrganizzazione implements Serializable {
	...
	@Column(name="COD_SEDE_LEGALE")
	private String codSedeLegale;
	...
	public String getCodSedeLegale() {
		return codSedeLegale;
	}

	public void setCodSedeLegale(String codSedeLegale) {
		this.codSedeLegale = codSedeLegale;
	}
