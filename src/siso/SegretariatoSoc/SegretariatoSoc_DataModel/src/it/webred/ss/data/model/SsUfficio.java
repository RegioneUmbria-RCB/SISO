...
@NamedQuery(name="SsUfficio.findAll", query="SELECT c FROM SsUfficio c order by c.nome")
public class SsUfficio implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="SS_UFFICIO_ID_GENERATOR", sequenceName="SQ_SS_ID", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SS_UFFICIO_ID_GENERATOR")
	private Long id;
