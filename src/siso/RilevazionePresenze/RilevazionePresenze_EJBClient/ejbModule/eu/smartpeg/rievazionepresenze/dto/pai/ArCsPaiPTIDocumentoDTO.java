...
public class ArCsPaiPTIDocumentoDTO implements Serializable {
	...
	public void initInfoSintetiche(Long idDoc, String codRouting, Long idPaiPTI) {
		if (arCsPaiInfoSinteticheDTO == null) {
			arCsPaiInfoSinteticheDTO = new ArCsPaiInfoSinteticheDTO(idPaiPTI, codRouting, idDoc, false, false, false,
