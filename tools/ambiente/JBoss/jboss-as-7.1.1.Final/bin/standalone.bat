...
rem PULIZIA CARTELLA DEPLOY
set "DEPLOY_CLEANER=%DIRNAME%jboss-deploy-cleaner.bat"
echo Calling "%DEPLOY_CLEANER%"
   call "%DEPLOY_CLEANER%" %*
pause

echo "x+STANDALONE_CONF = x%STANDALONE_CONF%"
rem Read an optional configuration file.
if "x%STANDALONE_CONF%" == "x" (
   set "STANDALONE_CONF=%DIRNAME%standalone.conf.bat"
   echo "SETTATO STANDALONE_CONF = %STANDALONE_CONF%"
)
